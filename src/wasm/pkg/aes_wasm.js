...
const Aes128Ctr128BEKeyFinalization = true
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_aes128ctr128bekey_free(ptr >>> 0, 1));
...
export class Aes128Ctr128BEKey {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        Aes128Ctr128BEKeyFinalization;
        return ptr;
    }

    [Symbol.dispose]() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_aes128ctr128bekey_free(ptr, 0);
    }
    /**
     * @param {Memory} key
     * @param {Memory} iv
    ...
    constructor(key, iv) {
        ...
        const ret = wasm.aes128ctr128bekey_new(key.__wbg_ptr, iv.__wbg_ptr);
        if (ret[2]) {
